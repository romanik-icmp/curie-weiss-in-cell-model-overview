...
%	\end{equation}
	...
	If we do not consider $y$ as an independent variable, but rather as a function of other two variables - $T^*$ and $\mu^*$, we rewrite the derivatives as follows.
	
	Partial derivatives with respect to $\mu^*$ become
	\begin{equation}
		\frac{\partial K_n(T^*,\mu^*;y)}{\partial \mu^*} \bigg|_{T^*} = \left(\frac{1}{T^*} + \frac{\partial y}{\partial \mu^*}\bigg|_{T^*} \right)K_{n+1}(T^*,\mu^*;y).
	\end{equation}
	
	Partial derivatives with respect to $T^*$ become
		\begin{equation}
		\frac{\partial K_n(T^*,\mu^*;y)}{\partial T^*} \bigg|_{\mu^*} = \frac{1}{T^*} \left(\frac{3}{2} - \frac{\mu^*}{T^*} + T^* \frac{\partial y}{\partial T^*}\bigg|_{\mu^*}\right) K_{n+1}(T^*,\mu^*;y).
	\end{equation}
