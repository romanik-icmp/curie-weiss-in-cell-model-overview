...
\begin{document}
	...
	\textbf{Interaction.} The interaction energy between particles in configuration $\gamma = \{x_1, ..., x_N\}$, where $x_i$ is the space coordinate of the $i$-th particle and $N$ is the number of particles in the configuration $\gamma$, is defined as follows
	\begin{equation*}
	...
	\textbf{The grand partition function} is expressed as follows~\cite{hansen2013theory}[eqs.~(2.4.6) and~(2.3.13)]
	\begin{equation*}
