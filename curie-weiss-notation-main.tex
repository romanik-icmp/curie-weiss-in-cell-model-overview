...
\begin{document}
	...
	\end{eqnarray}
	Here we used an obvious result $\int_{\Delta_l} {\rm d}x = v$. It is natural to introduce dimensionless variable
	\begin{equation}
		v^* = \frac{v}{\Lambda^3_J},
	\end{equation}
	where $\Lambda_J = (2\pi\hbar^2/mJ_1)^{1/2}$, and, thus, write down the final expression for $R_{N_v}$
	\begin{equation}
		\label{eq:RNv}
