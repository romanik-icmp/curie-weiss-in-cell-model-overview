...
\begin{document}
	...
	\begin{figure}[htbp]
		\includegraphics[width=0.45\textwidth,angle=0]{S_vs_T1}
		\hfill
		\includegraphics[width=0.45\textwidth,angle=0]{S_vs_T2}
		\\
		%\captionsetup{width=0.5\textwidth}
		\parbox{0.45\textwidth}{\caption{\label{fig:S_vs_T1} Entropy $S^*(\bar{y},T^*,\mu^*)$ as a function of $T^*$ at $\mu^*=-1.0$ ($v^* = 5$)}}
		\hfill
		%\captionsetup{width=0.5\textwidth}
		\parbox{0.45\textwidth}{\caption{\label{fig:S_vs_T2} Entropy $S^*(\bar{y},T^*,\mu^*)$ as a function of $T^*$ at $\mu^*=-1.0$ ($v^* = 5$)}}
	\end{figure}
	
	Figures~\ref{fig:S_vs_T1} and~\ref{fig:S_vs_T2} illustrate the dependence of entropy $S^*$ on temperature $T^*$ at constant chemical potential. The two figures show the same functional dependency but focus on different temperature ranges.
	...
	\begin{equation}
		\frac{\partial P^*}{\partial \mu^*} = T^* \frac{\partial E}{\partial \mu^*}.
	\end{equation}
	Then
	\begin{equation}
