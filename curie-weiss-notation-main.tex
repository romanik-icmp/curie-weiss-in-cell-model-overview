...
\begin{document}
	...
	\begin{figure}[htbp]
		\includegraphics[width=0.45\textwidth,angle=0]{E1_vs_y}
		\hfill
		\includegraphics[width=0.45\textwidth,angle=0]{E2_vs_y}
		\\
		%\captionsetup{width=0.5\textwidth}
		\parbox{0.45\textwidth}{\caption{\label{fig:E1_vs_y} Quantity $E_1(y,p,\mu)$ as a function of $y$ at $p=2.0$ and $\beta\mu=-2.0$ for two different values of $v^*$: Solid line (black): $v^* = 10$, Dash line (blue): $v^* = 5$.}}
		\hfill
		%\captionsetup{width=0.5\textwidth}
		\parbox{0.45\textwidth}{\caption{\label{fig:E2_vs_y} Quantity $E_2(y,p,\mu)$ as a function of $y$ at $p=2.0$ and $\beta\mu=-2.0$ for two different values of $v^*$: Solid line (black): $v^* = 10$, Dash line (blue): $v^* = 5$.}}
	\end{figure}
	...
	\begin{eqnarray}
		S^* & = & \frac{v}{k_{\rm B}} \left(\frac{\partial P}{\partial T}\right)_{\mu}
		\\
		& = & \left(\frac{\partial P^*}{\partial T^*}\right)_{\mu}
	\end{eqnarray}
	By~\eqref{eos:reduced}
	\begin{equation}
		S^* = E(\bar{y},T^*,\mu^*) + T^* \left(\frac{\partial E(\bar{y},T^*,\mu^*)}{\partial T^*}\right)_{\mu}
	\end{equation}
	The result of calculation is
	\begin{equation}
		S^* = -\frac{y^2}{p} + \ln K(\bar{y},p,\mu) + \frac{\left[\left(\frac{3}{2} - \beta\mu\right)K_1(\bar{y},p,\mu) + \frac{ap}{2}K_2(\bar{y},p,\mu) \right]}{K(\bar{y},p,\mu)}
	\end{equation}
	...
	This appendix contains explicit calculation of entropy by taking dirivative of pressure with respect to temperature.
	\begin{equation}
		S^* = E + T^* \left(\frac{\partial E}{\partial T^*}\right)_{\mu};
	\end{equation}
	\begin{equation}
	...
	\end{equation}
	The final result for the entropy is
	\begin{equation}
		S^* = -T^* \bar{y}^2 + \ln K + \frac{1}{K} \left[\left(\frac{3}{2} - \frac{\mu^*}{T^*} \right)K_1 + \frac{a}{2 T^*} K_2\right].
	\end{equation}
